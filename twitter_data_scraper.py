...
client = pymongo.MongoClient("mongodb+srv://suhail:suhail2000@cluster0.bzhk06k.mongodb.net/?retryWrites=true&w=majority")
...
def main():
  ...
  if choice=="Home":
    ...
    image = Image.open(r"C:\Users\suhail ahmed\Guvi\elonmusktwt.png")
